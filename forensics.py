...
if __name__ == "__main__":
    # Your target paths
    folders = {
        "FAKE": r"C:\Users\HCES\MyProject\data\raw\fake",
        "REAL": r"C:\Users\HCES\MyProject\data\raw\real"
    }
    ...
    for category, folder_path in folders.items():
        ...
        for image_name in images:
            ...
            results = run_enhanced_forensic_analysis(full_path)
            
            print(f"  > Combined Risk: {results['enhanced_combined_risk']}%")
            print(f"  > Level: {results['enhanced_risk_level']}")
            print("-" * 30)
