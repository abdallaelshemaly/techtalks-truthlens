...
This appears as "Settings" in Streamlit's sidebar.
"""
...
with st.sidebar:
    ...
    st.markdown("""
    Configure TruthLens to match your workflow.
    
    **Tabs:**
    1. **General:** Basic app settings
    2. **Analysis:** Detection options and thresholds
    3. **API:** Backend connection settings
    4. **Appearance:** UI customization
    
    **Note:** Settings are saved to your browser's local storage.
    """)
