...
def main():
    ...
    # Process fake images
    process_directory("C:\\Users\\Lenovo\\Downloads\\techtalks-truthlens-main\\data\\fake", fake_output, target_size=(224, 224))
    
    # Process real images
    process_directory("C:\\Users\\Lenovo\\Downloads\\techtalks-truthlens-main\\data\\real", real_output, target_size=(224, 224))
