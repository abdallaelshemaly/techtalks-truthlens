"""
Image Preprocessing Script for TechTalks-TruthLens
...
def create_directories():
    ...
    processed_dir = Path("techtalks-truthlens-main/data/processed")
...
def main():
    ...
    # Process fake images
    process_directory("techtalks-truthlens-main/data/fake", fake_output, target_size=(224, 224))
    
    # Process real images
    process_directory("techtalks-truthlens-main/data/real", real_output, target_size=(224, 224))
    
    print("\n" + "=" * 60)
    print("Preprocessing complete!")
    print(f"Processed images saved to: techtalks-truthlens-main/data/processed/")
    print("=" * 60)
